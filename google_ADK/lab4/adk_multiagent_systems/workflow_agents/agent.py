...
screenwriter = Agent(
    ...
    generate_content_config=types.GenerateContentConfig(
        temperature=0,
    #temp controls the randomness of the model's output
    #higher temp (0.9) makes the o/p more creative and diverse as the model is more willing to choose less likely words
    # a lower temp, makes o/p more focused and deterministic
    ),
